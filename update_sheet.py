...
# आपकी शीट की ID 
spreadsheet_id = "1Lh6vNku8ihyl2Fz8RLvdZSTnKrWfACkEIDx9VYVNAuA"


# दोनों शीट्स को कनेक्ट करना
try:
    ws_volume = client.open_by_key(spreadsheet_id).worksheet("Top 250 Stocks")मल्टीबैगर स्टॉक विश्लेषण
...
# 4. Update Both Sheetsवेब Apps और ऑनलाइन टूल
